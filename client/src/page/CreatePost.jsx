        ...
        <section className="max-w-7xl max-auto">
            <div>
                ...
                <p className="mt-2 text-[#666e75] text-[14px] max-w-[500px]">
                    Create imaginative and visually stunning images through AI and share them with the community</p>
            </div>
            <form className="mt-16 mx-w-3xl" onSubmit={handleSubmit}>
                ...
                <div className="mt-5 flex gap-5">
                    <button
                        ...
                        className="text-white bg-green-700 font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.3 text-center"
                    >
